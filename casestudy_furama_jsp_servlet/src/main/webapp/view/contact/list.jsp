                    ...
                    <div class="container  mt-2 p-2 mb-2" style="border: 1px solid grey; border-radius: 15px">
                        <form class="row" action="" method="post">
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-striped" id="tableFacilityContact" style="display: none;">
                                    <tr>
...
<script>
    function displayAttachFacility() {
        document.getElementById("tableFacilityContact").style.display='block'
        document.getElementById("buttonHide").style.display='block'

    }
    function hideAttachFacility() {
        document.getElementById("tableFacilityContact").style.display='none'
